...
@section('content')
@include('marketplace::_breadcrumbs', ['admin' => true, 'items' => [['label' => trans('marketplace::admin.categories.title'), 'url' => route('marketplace.admin.categories.index')], ['label' => trans('marketplace::admin.categories.create')]]])

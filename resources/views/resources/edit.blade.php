...
<div class="container content">
    ...
    <form method="POST" action="{{ route('marketplace.resources.update',$resource) }}" enctype="multipart/form-data" id="captcha-form">@method('PUT') @include('marketplace::resources._form')</form>
</div>
@endsection
